...
export default function Footer() {
  return <footer className="site-footer">
    ...
    <div className="footer-social"><p className="eyebrow">FOLLOW THE STUDIO</p><div className="footer-social-grid"><a href="https://www.instagram.com/meenakshiartwork/" target="_blank" rel="noopener noreferrer" className="social-card"><div className="social-card-image" style={{backgroundImage:"url('/images/social/instagram-preview.webp')"}}></div><div className="social-card-body"><div className="social-icon"><InstagramIcon /></div><h4>Instagram</h4><p>Behind the scenes & studio stories</p></div></a><a href="https://www.youtube.com/@meenakshiartwork6709" target="_blank" rel="noopener noreferrer" className="social-card"><div className="social-card-image" style={{backgroundImage:"url('/images/social/youtube-preview.webp')"}}></div><div className="social-card-body"><div className="social-icon"><YouTubeIcon /></div><h4>YouTube</h4><p>Academy tutorials & artist interviews</p></div></a><a href={GOOGLE_MAPS_URL} target="_blank" rel="noopener noreferrer" className="social-card"><div className="social-card-image" style={{backgroundImage:"url('/images/studio-exterior.webp')"}}></div><div className="social-card-body"><div className="social-icon"><GoogleIcon /></div><h4>Google</h4><p>Studio location & 5-star reviews</p></div></a><div className="social-card"><div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",padding:"20px"}}><PinterestEmbed /></div></div></div></div>
